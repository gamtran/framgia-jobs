$(window).ready(function(){
	...
	CW.reg_cmp.push({key:/\(mong\)/g, rep: "<img src='http://www.bestemoticon.com/smiley/sexe/sexes186.png' alt='(mong)' title='(mong)' class='ui_emoticon'/>", reptxt:'(mong)'});
        CW.reg_cmp.push({key:/\(kimdungun\)/g, rep: "<img src='http://i1280.photobucket.com/albums/a481/Linh_chim/kimjungun_zpsc6555a50.jpg' alt='(kimdungun)' title='(kimdungun)' class='ui_emoticon'/>", reptxt:'(kimdungun)'});
        CW.reg_cmp.push({key:/\(2lanhtu\)/g, rep: "<img src='http://i1280.photobucket.com/albums/a481/Linh_chim/2lanhtuu_zps6f46f4eb.jpg' alt='(2lanhtu)' title='(2lanhtu)' class='ui_emoticon'/>", reptxt:'(2lanhtu)'});
	...
	CW.reg_cmp.push({key:/\(rock\)/g, rep: "<img src='http://www.skype-emoticons.com/images/emoticon-00178-rock.gif' alt='(rock)' title='(rock)' class='ui_emoticon'/>", reptxt:'(rock)'});
	CW.reg_cmp.push({key:/\(envy\)/g, rep: "<img src='http://www.skype-emoticons.com/images/emoticon-00132-envy.gif' alt='(envy)' title='(envy)' class='ui_emoticon'/>", reptxt:'(envy)'});
	//Yahoo	
CW.reg_cmp.push({key:/\(hollest\)/g, rep: "<img src='http://i1280.photobucket.com/albums/a481/Linh_chim/hollest_zpsefd03293.gif' alt='(hollest)' title='(hollest)' class='ui_emoticon'/>", reptxt:'(hollest)'});
