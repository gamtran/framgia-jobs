...
#app_directory = "/usr/local/rails_apps/framgia-jobs/current"
app_directory = "/home/deploy/framgia-jobs"
working_directory app_directory # available in 0.94.0+

# listen on both a Unix domain socket and a TCP port,
# we use a shorter backlog for quicker failover when busy
listen "/tmp/unicorn_framgia-jobs.sock", :backlog => 128
listen 3000
...
pid "/tmp/unicorn_framgia-jobs.pid"
